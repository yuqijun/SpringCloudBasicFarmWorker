...
public class AESUtil {
    ...
    //自定义密码
    public static final String ASSETS_DEV_PWD_FIELD = "123456";
...
//            throw  new BusinessException(401,"AES  加密异常");
        }
        return null;
    }
    ...
    public static void main(String[] args) {
        String origin = "{\"userId\":\"61\",\"username\":\"yqj\",\"password\":\"123456\",\"authorities\":[{\"authority\":\"USER\"},{\"authority\":\"ADMIN\"}]}";
